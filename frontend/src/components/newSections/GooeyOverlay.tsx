...
export const GooeyOverlay: React.FC = () => {
  ...
  const getUniforms = (gl: WebGLRenderingContext, program: WebGLProgram): Uniforms => {
  ...
  const render = () => {
    ...
    gl.uniform1f(uniformsRef.current.u_scroll_progr, paramsRef.current.scrollProgress);
  ...
  useEffect(() => {
    ...
    }).to(paramsRef.current, { scrollProgress: 1 }, 0);
